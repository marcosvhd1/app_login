...
const String appOnBoardingSubTitle1 = "Let's start your journey";
...
const String appWelcomeSubTitle = "Let's start your journey";

const String appLoginText = "Login";
const String appSignupText = "Sign Up";
...
const String appDontHaveAccount = "Don't Have an Account? ";

const String appSignUpTitle = "Get On Board!";
const String appSignUpSubTitle = "Create your profile to start your journey with us...";
const String appAlreadyHaveAccount = "Already Have an Account? ";
...
const String appResetViaEmail = "Reset via E-mail verification.";
const String appResetViaEmailSubTitle = "Enter your registered E-mail to receive OTP";
const String appResetViaPhone = "Reset via Phone verification.";
const String appResetViaPhoneSubTitle = "Enter your registered Phone N° to receive OTP";
