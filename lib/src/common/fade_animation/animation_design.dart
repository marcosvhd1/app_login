...
class AppFadeAnimation extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final fadeAnimation = Get.put(AppFadeAnimationController());
    return Obx(
      () => AnimatedPositioned(
        duration: Duration(milliseconds: durationInMs),
        top: fadeAnimation.animated.value
            ? animate!.topAfter
            : animate!.topBefore,
        left: fadeAnimation.animated.value
            ? animate!.leftAfter
            : animate!.leftBefore,
        bottom: fadeAnimation.animated.value
            ? animate!.bottomAfter
            : animate!.bottomBefore,
        right: fadeAnimation.animated.value
            ? animate!.rightAfter
            : animate!.rightBefore,
